...
- 当服务端的所有请求的数据包发送完毕后，客户端会根据数据包的SEQ值进行排序组装，然后根据[套接字](https://baike.baidu.com/item/%E5%A5%97%E6%8E%A5%E5%AD%97/9637606?fr=aladdin)传送到相应的应用程序，再按HTTP协议的规定进行转换使用。
